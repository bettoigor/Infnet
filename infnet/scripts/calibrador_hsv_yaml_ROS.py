...
# starting
num_mask = int(raw_input('How many masks do you want to create?: '))
file_name = raw_input('Enter file name: ')
img_topic = raw_input('Enter topic name: ')
...
# creating ROS initalization

rospy.init_node('calibrator', anonymous=True)
rospy.Subscriber(img_topic, Image, callback_img)     # nome do node de publucação de imagem
rate = rospy.Rate(30) 
rospy.sleep(1)
